...
namespace DPSF.ParticleSystems
{
    ...
    [Serializable]
#endif
    public class ShipParticleSystem : DefaultSpriteParticleSystem
    {
        ...
        public ShipParticleSystem(Game cGame, Vector2 initialPos, float rotation, Vector2 velocity) : base(cGame) { this.intialPos = initialPos; this.rotation = rotation; this.velocity = velocity; }
